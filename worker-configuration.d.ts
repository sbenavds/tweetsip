/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2f9a0d6eb23cee78be57a4744f7388bd)
// Runtime types generated with workerd@1.20260305.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "AccountMonitor";
	}
	interface Env {
		R2: R2Bucket;
		DB: D1Database;
		QUEUE: Queue;
		AI: Ai;
		BETTER_AUTH_URL: "https://tweetsip.sbenavds-account.workers.dev";
		DEMO_USER_ID: "UXUqg5ODWjsgIvx2DnC0sbN02k0xSPdZ";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "DEMO_USER_ID">> {}
}
